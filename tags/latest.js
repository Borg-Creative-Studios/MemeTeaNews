function latest(){
    /* Top most entry */
    document.getElementById("title1").innerHTML = 'National Gas Price Average - 10/29/22'
    document.getElementById("content1").innerHTML = '$3.761'
    document.getElementById("content01").innerHTML = ''
    document.getElementById("link1").innerHTML = ''
    document.getElementById("link1").href = ''
    document.getElementById("time1").innerHTML = '10/29/22 4:40pm MST'
    document.getElementById("telegram1").href = 'https://t.me/openteanews/38'
    ...
    document.getElementById("title111").innerHTML = ''
    ...
    document.getElementById("time111").innerHTML = '00/00/22 00:00apm MST'
