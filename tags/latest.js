function latest(){
    ...
    document.getElementById("title2").innerHTML = 'Biden calls Gov Jared Polis'
    document.getElementById("content3").innerHTML = '<p>-The two discussed the recent wild fires in CO</p><p>-FEMA is on the ground assisting</p>'
    document.getElementById("content4").innerHTML = ''
    document.getElementById("link2").innerHTML = ''
    document.getElementById("link2").href = ''
    document.getElementById("time2").innerHTML = '12/31/21 2:15pm'

    /* Recent 3 */
    
    document.getElementById("title3").innerHTML = 'Betty White has passed away at the age of 99.'
    ...
    document.getElementById("time3").innerHTML = '12/31/21 11:53am'
}
