function latest(){
    ...
    document.getElementById("content01").innerHTML = '<p>-Anonymous says that it has leaked a database from the RMD website</p><p>-(Feb 26) Kyiv makes it through the night</p> <p>-(Feb 26) U.S. Pentagon: "we stand ready if called upon by NATO"</p> <p>-(Feb 26) Anonymous intercepts Russian military communications</p><p>-(Feb 26) Anonymous has operation to keep .ru gov sites down</p>  <p>This is a developing situation and encourage that you exercise caution with the sources you get info from.</p><p><a href="https://twitter.com/StateDept" target="_blank">@StateDept (Twitter)</a></p><p><a href="https://twitter.com/NATOinUkraine" target="_blank">@NATOinUkraine (Twitter)</a></p><p style="padding: 15px;"></p>'
    document.getElementById("link1").innerHTML = '@Ukraine (Twitter)'
    document.getElementById("link1").href = 'https://twitter.com/Ukraine'
    document.getElementById("time1").innerHTML = 'Updated 2/26/22 11:17am | Updated 2/26/22 12:32am | 2/24/22 2:22pm'
