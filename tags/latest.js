function latest(){
    ...
    document.getElementById("telegram111").href = 'https://t.me/openteanews/32'
     ...
     document.getElementById("title11111").innerHTML = 'Tempe FD, PHX FD, and PHX PD rescue injured hiker from Camelback Mountain.'
     document.getElementById("content11111").innerHTML = '"We please ask you to take all safety precautions before, during and after your hike." -@PHXFire'
     document.getElementById("content011111").innerHTML = ''
     document.getElementById("link11111").innerHTML = 'Read the Tweets'
     document.getElementById("link11111").href = 'https://twitter.com/PHXFire/status/1515418491892879360'
     document.getElementById("time11111").innerHTML = '4/16/22 4:42pm MST'
     document.getElementById("telegram11111").href = 'https://t.me/openteanews/29'
