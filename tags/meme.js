function memes(){
    ...
    document.getElementById("mcontent1").src = 'https://tea.borgcreative.com/memes/promo1.png'
    document.getElementById("mcontent2").innerHTML = ''
    document.getElementById("mlink1").innerHTML = ''
    document.getElementById("mlink1").href = ''
    document.getElementById("mtime1").innerHTML = '12/16/21 4:38pm'

    /* Recent 2 */

    document.getElementById("mtitle2").innerHTML = ''
    document.getElementById("mcontent3").src = 'https://tea.borgcreative.com/memes/pondering1.png'
    document.getElementById("mcontent4").innerHTML = ''
    document.getElementById("mlink2").innerHTML = ''
    document.getElementById("mlink2").href = ''
    document.getElementById("mtime2").innerHTML = '12/16/21 4:31pm'
