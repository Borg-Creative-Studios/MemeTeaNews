function older(){
    /* older 1 */
    document.getElementById("otitle1").innerHTML = 'All PHX PD officers harmed on Friday have been released from the hospital.'
    ...
    document.getElementById("otitle2").innerHTML = 'Week 23 of operation Hammer Strike:'
    document.getElementById("ocontent3").innerHTML = '<p>-31 suspects arrested</p>'
